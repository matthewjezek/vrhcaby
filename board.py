...
class Board:
    ...
    def make_board(self) -> None:
        ...
        pg.draw.polygon(self.window,self.color['whi'],[(c+gap+(5*x), 11*k), (b+gap+(5*x), self.size[1]), (a+gap+(5*x), self.size[1])],0)
        pg.draw.polygon(self.window,self.color['bla'],[(c+gap+(6*x), 11*k), (b+gap+(6*x), self.size[1]), (a+gap+(6*x), self.size[1])],0)
        pg.draw.polygon(self.window,self.color['whi'],[(c+gap+(7*x), 11*k), (b+gap+(7*x), self.size[1]), (a+gap+(7*x), self.size[1])],0)
        pg.draw.polygon(self.window,self.color['bla'],[(c+gap+(8*x), 11*k), (b+gap+(8*x), self.size[1]), (a+gap+(8*x), self.size[1])],0)
        pg.draw.polygon(self.window,self.color['whi'],[(c+gap+(9*x), 11*k), (b+gap+(9*x), self.size[1]), (a+gap+(9*x), self.size[1])],0)
        pg.draw.polygon(self.window,self.color['bla'],[(c+gap+(10*x), 11*k), (b+gap+(10*x), self.size[1]), (a+gap+(10*x), self.size[1])],0)
        pg.display.flip()